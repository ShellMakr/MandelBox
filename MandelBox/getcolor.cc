...
static double CamLightW = 1.2;// 1.27536;
static double CamLightMin = 0.4;// 0.48193;
//-----------------------------------
static const vec3 baseColor(1.0, 7.0, 3.0);
static const vec3 backColor(0.2,0.2,0.2);
//-----------------------------------
