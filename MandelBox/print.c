...
void printProgress( double perc, double time, int rank )
{
  ...
  OutputString = (char*)"*** completed % 5.2f%s ---  cum. time = %02d:%02d:%02d   % e (s) rank %d";
  sprintf(delete_space, OutputString, perc, "%%", hr, min, sec, time, rank);
